			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
					<div class="contactform">
						<h1 class="form-title text-center text-white">Get in Touch</h1>
						<form id="contact-form" method="POST" enctype="multipart/form-encode">
							...
							<div class="form-group">
								...
								<textarea rows="6" cols="60" name="message" class="form-control" id="messages" placeholder="Your message" tabindex="4"></textarea>                                 
							</div>
							<div class="text-center margin-top-25 mb-5">
...
<script>
	$(function(){
		$(document).on("submit", "#contact-form", function(event){
	        ...
	        $.ajax({
	        	url:"includes/contact-process",
	        	method:"post",
	        	data:contactformData,
	        	beforeSend:function(){
	        		$("#sendBtn").html('Sending...').attr("disabled", "disabled");
	        	},
	        	success:function(data){
	        		// $("#contact-form")[0].reset();
	        		$(".result").html(data);
	        		$("#sendBtn").html("Send Message").removeAttr("disabled");
	        	}
	        })
    	}) 
	})
