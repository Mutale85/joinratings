...
<body>
	...
	<div class="container mt-5">
		<div class="main_section">
			<div class="row">
				<div class="col-md-5">
					<h1 class="">Website Terms of Use</h1>
					<p class="fs-6">This refers to the terms of use set by Osabox Limited Company</p>
					<ul class="nav flex-column">
						...
						<li class="nav-item">
							<a class="nav-link" href="guidelines">Listing Guidelines</a>
						</li>
						<li class="nav-item">
				...
				<div class="col-md-7 text-secondary div-intro">

					<p>The joinratings.com website located at https://joinratings.com.com is a copyrighted work belonging to OSABOX. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
					...
					<p>Excluding any User Information that you may provide, you are aware that all the intellectual property rights, including copyrights, patents, trademarks, and trade secrets, in the Site and its content are owned by Company or Company’s suppliers.</p>

					<h2>What are Tokens</h2>
					<p>Token are points that joinratings.com provides to you either for free when you add up a User Information or for a fee when you no longer have free points to use. You agree that every User information you provide, there is no guarantee that you will get free tokens, as it is the discretion of the website owners. </p>
					<p>You also also agree to the effect that every time you search for User Information to match them with the data stored by joinratings.com will be, tokens or points will be deducted from your user account, and when you reach Zero, you will have the options to buy new tokens.</p>
					...
					<p><strong>Other Users.</strong> Each Site user is solely responsible for any and all of its own User Information.  Because we do not control User Information, you acknowledge and agree that we are not responsible for any User Information, whether provided by you or by others.  You agree that Company will not be responsible for any loss or damage incurred as the result of any such interactions.  If there is a dispute between you and any Site user, we are under no obligation to become involved.</p>
					...
					<p><strong>Cookies and Web Beacons.</strong> Like any other website, joinratings.com uses ‘cookies’. These cookies are used to store information including visitors’ preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users’ experience by customizing our web page content based on visitors’ browser type and/or other information.</p> -->
					...
					<p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: Plot 6, Limbs Road. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
					...
					<p>The Site may be subject to Zambia. export control laws and may be subject to export or import regulations in other countries. You agree not to export, re-export, or transfer, directly or indirectly, any Zambian technical data acquired from Company, or any products utilizing such data, in violation of the Zambian export laws or regulations.</p>
					...
					<p>Address: Plot 6, Limbs Road</p>
					<p><a href="contact" title="contact">Contact Us Here</a></p>
				</div>
