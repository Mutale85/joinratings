    ...
    <script>
        ...
        function makePayment() {
            ...
            FlutterwaveCheckout({
                ...
                'http://localhost/joinratings.com/car-hiring/token-payment?parent_id='+parent_id+'&phonenumber='+phonenumber.value+'&email='+email+'&username='+username+'&currency='+currency+'&amount='+amount,
                    meta: {
                    consumer_id: rand,
