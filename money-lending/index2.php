		...
		<div class="row">
			<div class="col-md-12 mb-5">
				...
				<div class="d-flex justify-content-between">
					<button type="button" class="button-34" data-bs-toggle="modal" data-bs-target="#exampleModal">
						Add Client
					</button>
					<button type="button" class="button-34" data-bs-toggle="modal" data-bs-target="#SearchModal">
						Search Client
					</button>
				</div>
			</div>
						...
						<form method="get" id="searchForm" action="search">
							...
							<div class="modal-body">
								<div class="form-group">
									...
									<input type="text" name="q" id="q" class="form-control" placeholder="NRC / License" required>
									<input type="text" name="org" id="org" class="form-control" value="<?php echo trim(base64_encode($_SESSION['parent_id']))?>">
								</div>
							</div>
							<div class="modal-footer d-flex justify-content-between">
								<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
